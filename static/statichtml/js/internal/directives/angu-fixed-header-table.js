        ...
        return {
            ...
            link: function ($scope, $elem, $attrs, $ctrl) {
                function isVisible(el) {
					console.log("into is visible = "+ el);
                ...
                $scope.unbindWatch = $scope.$watch(isTableReady,
                    function (newValue, oldValue) {
                        ...
                        if (newValue === true) {
                           ...
                           // $scope.unbindWatch();
							...
							$scope.$on('callDir',function(event, data){
								console.log("into call dir");
            					$scope.unbindWatch();
         					});
            }
        };
