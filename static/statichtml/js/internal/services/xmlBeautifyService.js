dashboardApp.service('xmlBeautifyService', function($log) {
    this.createShiftArr = function(step) {
        var space = '';
    ...
    this.prettify = function(xml, indent) {
        ...
        var len = arr.length,
            ...
            depth = 0,
            string = '',
            shift = this.createShiftArr(indent);
